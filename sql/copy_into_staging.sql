...
DELETE FROM supplychain.nyc_greentaxi USING nyc_greentaxi_tmp WHERE supplychain.nyc_greentaxi.vendorid = nyc_greentaxi_tmp.vendorid 
AND supplychain.nyc_greentaxi.lpep_pickup_datetime = nyc_greentaxi_tmp.lpep_pickup_datetime;
